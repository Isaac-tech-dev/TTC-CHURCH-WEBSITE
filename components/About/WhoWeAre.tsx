...
const WhoWeAre = () => {
  return (
    <section className={`px-[20px] md:px-[60px] py-[20px]`}>
      <h2 className={`md:text-[40px] text-[20px] text-[#231F60] font-bold`}>
        WHO WE ARE
      </h2>
      <div>
        <p className={`md:text-[18px] text-[14px] leading-[30px]`}>
          ...
          Christ, growing in love, and devoted to a life of prayer, worship, and
          the miraculous.
        </p>
        <br />
        <p className={`md:text-[18px] text-[14px] leading-[30px] font-normal`}>
          ...
          accommodate you and small enough to identify you. Whether you are just
          beginning your journey of faith or seeking a deeper connection with
        ...
        <p className={`md:text-[18px] text-[14px] leading-[30px] font-normal`}>
          ...
          reality. Through worship, the Word, and community, every member
          experiences a <strong>Triumphant life in Christ.</strong>
        </p>
      </div>
    </section>
  );
